...
public class ContactFormTest {
    ...
    public void setupData() {
        ...
        marcUsher.setStatus(Contact.Status.NotDecided);
    ...
    public void formFieldsPopulated() {
        ...
        Assert.assertEquals(Contact.Status.NotDecided, form.status.getValue());
    }
    @Test
    public void saveEventHasCorrectValues() {
        ...
        form.status.setValue(Contact.Status.AndroidDeveloper);
        ...
        Assert.assertEquals(Contact.Status.AndroidDeveloper, savedContact.getStatus());
    }
}